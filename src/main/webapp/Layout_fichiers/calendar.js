...
var calendar_offsetLeft = 10;	// Offset - calendar placement - You probably have to modify this value if you're not using a strict doctype
...
function initPathImagesCalendar(path) {
	pathToImages = path+"/";
}
